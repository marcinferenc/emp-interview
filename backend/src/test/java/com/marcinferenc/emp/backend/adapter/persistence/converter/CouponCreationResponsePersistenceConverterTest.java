...
class CouponCreationResponsePersistenceConverterTest {
    private final CouponCreationResponsePersistenceConverter converter = new CouponCreationResponsePersistenceConverter();
